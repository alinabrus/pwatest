...
class API_Profiler // extends CI_Profiler
{
	/*
	...
	*/
	 ...
	 * @return	string
	 */
	protected function _compile_queries__()
	{
		$dbs = array();
	...
	public function run()
	{
            ...
            //logmes('$logname = ',$logname,'zzz');
            //logmes('$output = ',$output,'zzz');
	...
	{
		$filepath = APPPATH.'logs/'.$logname.'-log-'.date('Y-m-d').EXT; // $this->log_path
		$message  = '';
