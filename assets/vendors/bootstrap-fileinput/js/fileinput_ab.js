...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        raise: function (event, params, data) {
        ...
        showUploadError: function (msg, params, event) {
        	console.log('_________ showUploadError:  ', msg);
        ...
        showError: function (msg, params, event) {
            ...
            //console.log('[MX] showError:  ', msg);
            $('body').append('<span id="mxFileinputErrMsg" style="display: none;"></span>');
            $('#mxFileinputErrMsg').html(msg);
            var errMsg = $('#mxFileinputErrMsg').text();
            $('#mxFileinputErrMsg').remove();
            //console.log('[MX] showError:  ', errMsg);
            
            self.raise(ev, [params], {errMsg: errMsg});
            if (!self.isUploadable) {
                self.clearFileInput();
            }
            self.$container.removeClass('file-input-new');
        ...
        checkDimensions: function (i, chk, $img, $thumb, fname, type, params) {
        	//console.log('@@@@___', i, chk, $img, $thumb, fname, type, params);
